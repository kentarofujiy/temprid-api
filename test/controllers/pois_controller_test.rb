...
class PoisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poi" do
    assert_difference('Poi.count') do
      post pois_url, params: { poi: { address: @poi.address, lat: @poi.lat, lng: @poi.lng, string: @poi.string, title: @poi.title } }
    end
  ...
  test "should update poi" do
    patch poi_url(@poi), params: { poi: { address: @poi.address, lat: @poi.lat, lng: @poi.lng, string: @poi.string, title: @poi.title } }
